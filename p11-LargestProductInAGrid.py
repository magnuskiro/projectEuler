...
#get down right, and up right in the same traverse. 
#get down, and right.
    # 0,0 1,1 2,2 3,3 - down right
    # 3,0 2,1 1,2 0,3 - up right
    for i in range(0,19-2): # gives 17 iterations. 
        for j in range(0,19-2): # 17 iterations 
            # down right diagonal
            sums.append(grid[i][j]*grid[i+1][j+1]*grid[i+2][j+2]*grid[i+3][j+3])
            # up right diagonal
            sums.append(grid[i+3][j]*grid[i+2][j+1]*grid[i+1][j+2]*grid[i][j+3])
            # right
            sums.append(grid[i][j]*grid[i][j+1]*grid[i][j+2]*grid[i][j+3])
